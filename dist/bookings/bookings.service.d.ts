...
export declare class BookingsService {
    ...
    private dataSource;
    constructor(bookingRepository: Repository<Booking>, flightSeriesRepository: Repository<FlightSeries>, passengerRepository: Repository<Passenger>, bookingPassengerRepository: Repository<BookingPassenger>, seatReservationRepository: Repository<SeatReservation>, agencyRepository: Repository<Agency>, agencyLedgerRepository: Repository<AgencyLedger>, accountRepository: Repository<Account>, accountLedgerRepository: Repository<AccountLedger>, journalEntryRepository: Repository<JournalEntry>, journalEntryLineRepository: Repository<JournalEntryLine>, chartOfAccountRepository: Repository<ChartOfAccount>, passengersService: PassengersService, dataSource: DataSource);
