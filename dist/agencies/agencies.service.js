...
let AgenciesService = class AgenciesService {
    ...
    agencyDepositRepository;
    accountRepository;
    accountLedgerRepository;
    constructor(agencyRepository, agencyLedgerRepository, agencyDepositRepository, accountRepository, accountLedgerRepository) {
    ...
    async update(id, updateAgencyDto) {
        ...
        if (updateAgencyDto.contact !== undefined)
            agency.contact = updateAgencyDto.contact ?? null;
        if (updateAgencyDto.city !== undefined)
            agency.city = updateAgencyDto.city ?? null;
        if (updateAgencyDto.country !== undefined)
            agency.country = updateAgencyDto.country ?? null;
        if (updateAgencyDto.booking_limit !== undefined)
            agency.booking_limit = updateAgencyDto.booking_limit ?? null;
        if (updateAgencyDto.credit_limit !== undefined)
            agency.credit_limit = updateAgencyDto.credit_limit ?? null;
        if (updateAgencyDto.max_pax_per_booking !== undefined)
            agency.max_pax_per_booking = updateAgencyDto.max_pax_per_booking ?? null;
        ...
        if (updateAgencyDto.credit_days !== undefined)
    ...
    async getAgencyLedger(agencyId) {
    ...
    async createDeposit(agencyId, createDepositDto) {
        ...
        if (!account) {
            throw new common_1.NotFoundException(`Account with ID ${createDepositDto.account_id} not found`);
        }
        if (agency.default_currency && account.currency && agency.default_currency !== account.currency) {
            throw new common_1.BadRequestException(`Currency mismatch. Agency uses ${agency.default_currency} but account uses ${account.currency}.`);
        }
...
exports.AgenciesService = AgenciesService = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(agency_ledger_entity_1.AgencyLedger)),
    __param(2, (0, typeorm_1.InjectRepository)(agency_deposit_entity_1.AgencyDeposit)),
    __param(3, (0, typeorm_1.InjectRepository)(account_entity_1.Account)),
    __param(4, (0, typeorm_1.InjectRepository)(account_ledger_entity_1.AccountLedger)),
